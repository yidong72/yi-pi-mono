...
type StaticProvider = keyof typeof MODELS;

type ModelApi<
	TProvider extends StaticProvider,
	TModelId extends keyof (typeof MODELS)[TProvider],
> = (typeof MODELS)[TProvider][TModelId] extends { api: infer TApi } ? (TApi extends Api ? TApi : never) : never;

export function getModel<TProvider extends StaticProvider, TModelId extends keyof (typeof MODELS)[TProvider]>(
	provider: TProvider,
	modelId: TModelId,
...
export function getModels<TProvider extends StaticProvider>(
	provider: TProvider,
